		...
		<form class="col s12">
			<div class="row">
				...
				<div class="input-field col s12">
					...
					<input id="password" type="password" v-model="user.password" v-validate:password="{ required: false, 
					minlength: 4 }" />
			...
			<div class="input-field col s12">
				<button class="waves-effect waves-light btn right" @click="doLogin" v-if="$validateForm.valid">
				Enviar</button>
			</div>
		</form>
	</validator>
